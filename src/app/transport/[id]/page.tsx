...
export default function TransportDetailPage() {
  ...
  const [item, setItem] = useState<Transport | null>(null);
    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow flex items-center justify-center flex-col gap-4">
          <p className="text-xl text-muted-foreground">Transport introuvable</p>
          <Button onClick={() => router.push('/transport')}>Retour aux transports</Button>
        </div>
        <Footer />
      </div>
    );
      ...
      <main className="flex-grow">
        <section className="relative h-[50vh] min-h-[350px] bg-muted">
          ...
          <div className="absolute top-4 left-4">
            <Button variant="secondary" size="sm" onClick={() => router.push('/transport')}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                {item.descriptionComplete && (
                  <div className="mb-8">
                    <h2 className="text-xl font-semibold text-primary mb-3">À propos de ce transport</h2>
