    ...
    <div className="p-4 sm:p-8 bg-secondary/50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-center mb-8 pb-4 border-b">
          ...
          <Button onClick={() => signOut(getAuthInstance()).then(() => router.push('/admin/login'))} variant="outline">
        ...
        <main>
          <Tabs defaultValue="dashboard" className="w-full">
            ...
            <TabsContent value="destinations">Gestion des destinations</TabsContent>
