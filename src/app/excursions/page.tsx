...
export const metadata = {
  title: 'Circuits et Excursions - SLAAC Voyages',
  description: "Circuits et excursions au Sénégal : Île de Gorée, Lac Rose, Casamance. Découvrez les trésors du Sénégal avec SLAAC Voyages.",
};
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow">
        <section className="relative h-[45vh] min-h-[340px] flex items-center justify-center text-white overflow-hidden">
          <Image src={HERO_IMG} alt="Circuits et Excursions" fill className="object-cover" priority sizes="100vw" />
          ...
          <div className="relative z-20 text-center px-4 max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg font-headline">Circuits et Excursions</h1>
        ...
        <section className="py-20 sm:py-28 bg-background">
          <div className="container mx-auto max-w-7xl px-4">
            <div className="text-center mb-14">
              ...
              <h2 className="mt-2 text-3xl md:text-4xl font-bold text-primary font-headline">Nos Offres</h2>
              <div className="w-16 h-0.5 bg-accent mx-auto my-5" />
        ...
        <section className="py-20 bg-secondary text-center">
          <div className="container mx-auto max-w-3xl px-4">
            ...
            <p className="text-muted-foreground text-lg text-balance">Réservez votre excursion ou circuit, ou demandez un programme sur mesure.</p>
            <div className="mt-8">
