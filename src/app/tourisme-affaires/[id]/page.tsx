...
export default function OffreAffairesDetailPage() {
  ...
  const [item, setItem] = useState<OffreAffaires | null>(null);
    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow flex items-center justify-center flex-col gap-4">
          <p className="text-xl text-muted-foreground">Offre introuvable</p>
          <Button onClick={() => router.push('/tourisme-affaires')}>Retour au tourisme d'affaires</Button>
        </div>
        <Footer />
      </div>
    );
      ...
      <main className="flex-grow">
        <section className="relative h-[50vh] min-h-[350px] bg-muted">
          ...
          <div className="absolute top-4 left-4">
            <Button variant="secondary" size="sm" onClick={() => router.push('/tourisme-affaires')}>
              ...
              <div className="lg:col-span-2">
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-2 text-muted-foreground">
                    ...
                    <span className="flex items-center gap-1"><Users className="h-4 w-4" /> {item.capacite}</span>
                  </div>
                </div>
                ...
                {item.descriptionComplete && (
                  <div className="mb-8">
                    <h2 className="text-xl font-semibold text-primary mb-3">À propos de ce service</h2>
                ...
                {item.services && item.services.length > 0 && (
                  <div className="mb-8">
                    <h2 className="text-xl font-semibold text-primary mb-4">Services inclus</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {item.services.map((eq, idx) => (
